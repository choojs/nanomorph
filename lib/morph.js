    ...
    if (attrNamespaceURI) {
      ...
      if (fromValue !== attrValue) {
        if (!attrValue || attrValue === 'null') {
          console.log('attriboo:removing', attrName, attrValue)
          oldNode.removeAttribute(attrName)
        } else {
          console.log('attriboo:setting', attrName, attrValue)
  ...
  if (!oldNode.hasAttributeNS(null, 'multiple')) {
    ...
    while (curChild) {
      ...
      if (nodeName && nodeName.toUpperCase() === 'OPTION') {
        var attr = curChild.getAttribute('selected')
        if (attr && attr !== 'null') break
        i++
      }
